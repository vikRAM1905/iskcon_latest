...
// Also handle any interaction when the app is in the background via a
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      //           arguments: _.recommendedList[index].id);  //==  your navigator method to Chat room class
      // } else {
      //   gotoNotifications();   //==  your navigator method for Notification class
      // }
      if (data == "2") {
        print(".............. article added");
        Get.toNamed(ROUTE_BOOK_INTRO, arguments: int.parse(message.data['id']));
      } else {
...
// If `onMessage` is triggered with a notification, construct our own
      ...
      if (notification != null && android != null) {
        print(".........///////..... ${android.sound}");
        print("data id: ---------- ${message.data['type']}");
        // Get.toNamed(ROUTE_BOOK_INTRO,
